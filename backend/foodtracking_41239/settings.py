"""
Django settings for foodtracking_41239 project.
...
ROOT_URLCONF = 'foodtracking_41239.urls'
...
WSGI_APPLICATION = 'foodtracking_41239.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "foodtracking_41239 API",
    "DESCRIPTION": "API documentation for foodtracking_41239 App",
    "VERSION": "v1",
}
